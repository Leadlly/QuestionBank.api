/**
 * Export Script — Standard 11, Maths
 *
 * Queries the DB and generates a hierarchical diff-style JSON file:
 *   scripts/standard/11/maths/segregation.json
 *
 ...
 *
 * Run:
 *   node scripts/standard/11/maths/exportSegregation.js
 */
...
async function exportSegregation() {
  ...
  // 1. Find the Maths subject for standard 11
  ...
  if (!subject) {
    console.error('❌  Subject "Maths" for standard 11 not found.');
