...
import { createTopic, deleteTopic, getTopic, getTopicById, updateTopic, updateTopicExamTags } from "../controller/topicController.js";
...
router.delete("/delete/null/topic/:id", deleteTopic);
